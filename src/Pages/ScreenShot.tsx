...
import THEshots from "../Components/THEshots";
import phone from "../assets/2.jpg";
import phone2 from "../assets/4.jpg";
import phone3 from "../assets/5.jpg";
import phone4 from "../assets/6.jpg";
  ...
  return (
    <div>
      <Container>
        ...
        <ScrnHolder>
          <THEshots Image={phone} />
          <THEshots Image={phone2} />
          <THEshots Image={phone3} />
          <THEshots Image={phone4} />
        </ScrnHolder>
      </Container>
    </div>
  );
